...
/* harmony import */ var _youtube_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./youtube.service */ "./src/app/youtube.service.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(spinner, youTubeService, sanitizer) {
    ...
    AppComponent.prototype.sea = function () {
        var _this = this;
        if (this.search == null) {
            this.iss = true;
            setTimeout(function () {
            ...
            this.youTubeService
                ...
                for (var _i = 0, _a = lista["items"]; _i < _a.length; _i++) {
                    var element = _a[_i];
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [ngx_spinner__WEBPACK_IMPORTED_MODULE_3__["NgxSpinnerService"],
            _youtube_service__WEBPACK_IMPORTED_MODULE_4__["YoutubeService"],
...
var YoutubeService = /** @class */ (function () {
    function YoutubeService(http) {
        this.http = http;
        this.apiKey = 'AIzaSyC7cBcKcrxjCqQjT10ZyyL2qN8TszgrEm8';
    }
    YoutubeService.prototype.getVideosForChanel = function (channel, maxResults) {
        var url = 'https://www.googleapis.com/youtube/v3/search?key=' + this.apiKey + '&order=date&part=snippet&type=video&q=' + channel + '&maxResults=' + maxResults;
